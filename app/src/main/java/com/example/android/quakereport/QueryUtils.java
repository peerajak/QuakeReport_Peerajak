...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String jsonRespond) {
        ...
        try {
            ...
            JSONObject jreader = new JSONObject(jsonRespond);
            ...
            for (int i = 0; i < jarray.length(); i++) {
                ...
                Log.i("QueryUtils", jproperites.getString("place")+" "+jproperites.getString("time")+" "+jproperites.getString("mag"));
            }
        } catch (JSONException e) {
            // If an error is thrown when executing any of the above statements in the "try" block,
            // catch the exception here, so the app doesn't crash. Print a log message
            // with the message from the exception.
            Log.i("QueryUtils",jsonRespond);
